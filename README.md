...
If your headers exceed (large `Cookie` header as an example) default 4096 buffer size limit you can tweak that with `GATUS_API_READ_BUFFER_SIZE` environment variable
